      ...
      try {
        if (selectedFile !== '') {
          ...
          if (enteredFileName != null) {
            ...
            axios.post("http://petrecs.herokuapp.com/api/upload/record", fileData, {withCredentials: true})
            .then((response) => {
              ...
              console.log(data);
              axios.post('http://petrecs.herokuapp.com/api/pet-records/', data, {withCredentials: true })
                .then((res) => {
                    console.log(res);
              })
            }, (error) => {
